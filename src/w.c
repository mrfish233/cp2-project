...
int main(int argc, char* argv[]) {
    ...
    setRenderAreaContent(&ctx, 0, "aa-24.bmp", images1, 1, texts1, &white, &textRect1, 1);
    ...
    setRenderAreaContent(&ctx, 1, "a24.bmp", images2, 1, texts2, textColors2, textRects2, 10);
    ...
    setRenderAreaContent(&ctx, 2, NULL, images3, 2, texts3, NULL, imageRects3, 0);
    ...
    setRenderAreaContent(&ctx, 3, "test.png", images4, 1, texts4, &white, &textRect4, 1);
